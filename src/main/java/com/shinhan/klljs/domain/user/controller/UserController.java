 ...
 * JWT의 sub 클레임(17절에서 발급 시 내부 userId로 채운 값)을 그대로 신뢰한다 —
...
public class UserController {
    ...
    public ApiResponse<UserMeResponse> me(@AuthenticationPrincipal Jwt jwt) {
        ...
        User user = userQueryService.getMe(userId);
        return ApiResponse.onSuccess(GeneralSuccessCode.OK, UserMeResponse.from(user));
    }
}
